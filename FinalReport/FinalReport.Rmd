...
To reproduce the report, you need to install package [phishing735](https://github.com/madzraman/phishing735/) first.
...
```{r, echo=FALSE, fig.cap="my caption", fig.align="center"}
knitr::include_graphics("figures/sparsity_table.png")
```

due to sparsity it was unnecessary to look at histograms of each variable...
...
\noindent We first split our dataset into a training (80\%) and test set (20\%). 
...
Compare Final predictions on test set (to "choose" best model)
